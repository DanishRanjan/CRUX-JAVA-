...
public class LinkedListKelementfromLast {
	private class Node {
		int data;
		Node next;
	...
	public LinkedListKelementfromLast() {
		this.head = null;
		this.tail = null;
		this.size = 0;
	}

	public LinkedListKelementfromLast(Node head, Node tail, int size) {
		this.head = head;
		this.tail = tail;
		this.size = size;
	}
...
//	}
	public int KthFromLast(int k) throws Exception {
		return this.getAt(this.size-k);
	}

	public static void main(String[] args) throws Exception {

		Scanner scn = new Scanner(System.in);
		LinkedListKelementfromLast list = new LinkedListKelementfromLast();
		while (true) {
			int n = scn.nextInt();
			if (n == -1) {
				break;
