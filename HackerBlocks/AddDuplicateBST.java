...
public class AddDuplicateBST {
	...
	public void duplicate() {
	    ...
	    private void duplicate(Node parent) {
                if(parent==null)
            {
                return;
            }
            
            Node prev=parent.left;
            Node nn=new Node(parent.data,null,null);
        	nn.data = parent.data;
			nn.left = prev;
			nn.right = null;
            ...
            duplicate(nn.left);
            duplicate(parent.right);
	    }
	    
	    public static void main (String[] args) {
	    	AddDuplicateBST bst=new AddDuplicateBST();
